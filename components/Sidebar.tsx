...
import { LayoutDashboard, Building2, HardHat, BrainCircuit, DatabaseZap, ShieldCheck, ChevronRight, FilePlus2 } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ currentView, onChangeView }) => {
  const menuItems = [
    ...
    { id: 'ai-analysis', label: 'Intelligence Artificielle', icon: BrainCircuit },
  ];
  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-72 bg-state-950 text-white flex flex-col z-30 border-r border-white/5 shadow-2xl">
      ...
      <div className="mt-auto p-8 border-t border-white/5">
        <div className="bg-emerald-900/20 rounded-2xl p-5 border border-emerald-500/10">
